...
/obj/structure/prop/hybrisa/vehicles/attack_alien(mob/living/carbon/xenomorph/user)
	...
	playsound(src, 'sound/ambience/shipambience.ogg', 20, 1)
	if(health <= 0)
...
/obj/structure/prop/hybrisa/vehicles/proc/explode(dam, mob/M)
	...
	playsound(loc, 'sound/ambience/shipambience.ogg', 20)
...
/obj/structure/prop/hybrisa/vehicles/bullet_act(obj/projectile/P)
	if(P.ammo.damage)
		...
		playsound(src, 'sound/ambience/shipambience.ogg', 35, 1)
		update_icon()
...
/obj/structure/prop/hybrisa/misc/detonator/attack_hand(mob/user)
	// Hybrisa detonator logic removed because mining explosive type is unavailable.
	return TRUE
