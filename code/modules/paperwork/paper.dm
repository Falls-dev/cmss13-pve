...
/obj/item/paper/pipevinRIP
	name = "paper- 'DEAD PIPEVIN XD'"
	info = {"
Персональный вейланд-ютани охранник Рик 'Мост' Рамирез был убит при исполнении своего служебного долга на территории колонии-шахты Кутджево Рефинери.
<br><br>
Проявив качества лидера, он сумел эвакуировать двух выживших сотрудников данной колонии, пожертвовав своей жизнью.
<br><br>
Это настоящий поступок лидера, лидер должен быть готов пожертвовать собой ради жизни других. Его утрата никогда не будет забыта.
<br><br>
<b>Спи спокойно, национальный герой ЮПП.</b>
"}
